...
<div class="panel panel-primary">
    <div class="panel-heading">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">{{ trans('app.user_list') }}</h1>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
            <p><strong class="badge bg-warning"> Note 1 </strong> &nbsp;If you delete a User then, the related tokens are not calling on the Display screen. Because the token is dependent on User ID</p>
            <p><strong class="badge bg-warning"> Note 2 </strong> &nbsp;If you want to change a User name you must rename the User instead of deleting it. 
            </p>
      </div>
